...
public:
    ...
    void load_data() {
        ifstream ifs;
        string input_file_name = "data/sample_M" + to_string(number_of_document) + "_nd5000_K" + to_string(correct_topic) + ".txt";
    ...
    void write_data() {
        ofstream ofs;
        string output_file_name = "result/sample_M" + to_string(number_of_document) + "_nd5000_K" + to_string(correct_topic) +  "/result_k";
	...
	ofs << "\n";
        ofs.close();
	ofstream FIC_out;
	output_file_name = "result/sample_M" + to_string(number_of_document) + "_nd5000_K" + to_string(correct_topic) + "/FIC_k";
        if(number_of_topic < 10){
	  output_file_name += "0" + to_string(number_of_topic) + ".txt";
        }
        else{
