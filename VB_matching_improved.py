...
output_file = "result/VB_sample_M" + args[1] + '_nd' + args[2] + '_K' + args[3] +'/figure/' + args[4] + '/matching_improved.txt' 

output = open(output_file,'w')
output.write(match)
output.close()

outJS_file = "result/VB_sample_M" + args[1] + '_nd' + args[2] + '_K' + args[3] + '/figure/' + args[4] + '/mean_JS.txt'
