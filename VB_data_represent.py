...
matching_file = "result/VB_sample_M" + args[1] + '_nd' + args[2] + '_K' + args[3] +'/figure/' + args[4] +"/matching_improved.txt"
...
df_file = "result/VB_sample_M" + args[1] + '_nd' + args[2] + '_K' + args[3] +'/figure/' + args[4] +"/df.csv"
...
for i in range(0,K*2,2):
    ...
    fig.tight_layout()
    name = 'result/VB_sample_M' + args[1] + '_nd' + args[2] + '_K' + args[3] + '/figure/' + args[4] + '/' + str((i+1)//2) + '_match.png'
